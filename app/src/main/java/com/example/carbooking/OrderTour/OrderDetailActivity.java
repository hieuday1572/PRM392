...
public class OrderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (!voteInput.isEmpty()) {
                    ...
                    if (voteValue >= 0 && voteValue <= 5) { // Assuming vote range
                        ...
                        boolean updateSuccess = tourRepository.updateTourVote(tourId, voteValue);
                        if (updateSuccess) {
        ...
        TextView tourName = findViewById(R.id.textview_tourname_detail);
        tourName.setText(String.valueOf(tourId));
